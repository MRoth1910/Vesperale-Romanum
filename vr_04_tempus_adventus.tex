...
\setcustomheader{sabbato ante dominicam i adventus.}
...
\idxhy{Te lucis ante terminum~06@– in Adventu}{2}{hy_te_lucis_ante_terminum_in_adventu_solesmes_1961}
...
\setcustomheader{dominica i adventus.}
...
\bigtitle{Feria II.}
\setcustomheader{infra hebdom. i adventus.}
...
\nextcustomheader{dominica ii adventus.}
...
\bigtitle{Feria II.}
\setcustomheader{infra hebdom. ii adventus.}
...
\nextcustomheader{dominica iii adventus.}
...
\bigtitle{Die 17.}
\setcustomheader{antiphonæ majores.}

\idxo{1}{Sapientia}{an_o_sapientia_solesmes_1961}

\rubrique{Cant. \normaltext{Magníficat} in tono solemni, \normaltext{\pageref{M-Magnificat_2_Solemnis}.}}%%pageref to that section since it's an exception to the rules
...
\setcustomheader{infra hebdom. iii adventus.}
...
\setcustomheader{dominica iv adventus.}
