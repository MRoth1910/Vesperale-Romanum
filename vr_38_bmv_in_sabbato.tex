...
%%\chapter{OFFICIUM B. MARIÆ V. IN SABBATO.}\cheader{officium b.m.v. in sabbato.}

%%\chapter[Toni Communes.]{OFFICIUM B. MARIÆ V. IN SABBATO.}\cheader{toni communes.} %% Need to redefine chapter to allow for optional argument to be used in TOC
...
\section[Officium B.M.V. in Sabbato]{OFFICIUM B.M.V. IN SABBATO.} \cheader{officium b.m.v. in sabbato.} %%will want to fix the white space here
