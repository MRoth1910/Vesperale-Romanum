...
\hymnusmode{I.}
\initialscore{hy_ave_maris_stella_in_sab_solesmes_1961}

\altertonus
\gscore[]{7.}{hy_ave_maris_stella_in_sab_mode_7_solesmes_1961}
...
\gscore[]{1. D2}{an_regina_caeli_off_bmv_in_sab_TP_solesmes_1961}

\rubrique{Oratio \normaltext{Concéde, \pageref{oratio_bmv}.} Commem. de Cruce.} %%will need a \pageref in normaltext
