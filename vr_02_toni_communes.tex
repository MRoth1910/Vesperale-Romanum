...
%\chapter{TONI COMMUNES.}\setcustomheader{toni communes.}

\chapter*{TONI COMMUNES.}
\addcontentsline{toc}{chapter}{Toni Communes.}
%\setcustomheader{toni communes.} 
%% Need to redefine chapter to allow for optional argument to be used in TOC

%\thispagestyle{empty}

\section[I. In Principio Vesperarum]{I. IN PRINCIPIO VESPERARUM.}\setcustomheader{i. in principio vesperarum.}
...
\section[II. Toni Psalmorum]{II. TONI PSALMORUM.}\setcustomheader{ii. toni psalmorum.}
...
\section[III. Toni Versiculorum]{III. TONI VERSICULORUM.}\setcustomheader{iii. toni versiculorum.}
...
\section[IV. Tonus Capituli]{IV. TONUS CAPITULI.}\setcustomheader{iv. tonus capituli.}
...
\section[V. Toni Orationum]{V. TONI ORATIONUM.}\setcustomheader{v. toni orationum.}
...
\section[VI. In fine Horarum]{VI. IN FINE HORARUM.}\setcustomheader{vi. in fine horarum.}
...
\section[VII. Toni ℣. Benedicamus Domino]{VII. TONI ℣. BENEDICAMUS DOMINO.}\setcustomheader{vii. toni ℣. benedicamus domino.}
...
\section[VIII. De Cantu Hymnorum]{VIII. DE CANTU HYMNORUM.}\setcustomheader{viii. de cantu hymnorum.}
...
\newpage
\section[IX. Toni « Alleluia »]{IX. TONI ALLELUIA.}\setcustomheader{ix. toni « alleluia ».}
