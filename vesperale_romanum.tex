...
\customsubfile{vr_NN_commune_confessoris_pontificis} %%doctors' names are a problem as is Iste confessor (sometimes) (Names working as of Oct 8 2024!!
...
\customsubfile{vr_NN_officium_parvum}
...
\customsubfile{vr_NN_pius_12_1960} %%(tbd if Anthony and Lawrence go here for "O Doctor Optime")
