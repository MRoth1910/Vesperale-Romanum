...
\customsubfile{vr_NN_commune_apostolorum} \customsubfile{vr_NN_commune_unius_martyris}
...
\customsubfile{vr_NN_commune_bmv} %% % need to ensure spacing at antiphon Sancta Maria
\customsubfile{vr_NN_bmv_in_sabbato}
\customsubfile{vr_NN_officium_parvum}
\customsubfile{vr_NN_officium_defunctorum}
\customsubfile{vr_NN_varia}
%%\customsubfile{vr_NN_prop_gallia} if feeling ambitious
\customsubfile{vr_NN_hymni_antiqui} 
\customsubfile{vr_NN_proprium_galliae}
\customsubfile{vr_NN_pius_12_1960}
