...
%%in particular for canticle at OPBMV
  \NewDocumentCommand{\canticumspecial}{mmm}{
	\needspace{4\baselineskip}%
	\smalltitle{#1.}%            %% needspace plus smalltitle with \vspace{baselineskip} adds a lot of white space
	\smallscore[n]{#2}%
	\cantiquetexte{#3}%
	}
...
%%for referring to chapter and hymn placed at I or II Vespers (where II has different parts)
