...
\makeindex[name=P,title=index psalmorum., options=vr_test_index,columns=2,columnseprule]
\makeindex[name=V,title=index variorum., options=vr_test_index,columns=2,columnseprule]
\makeindex[name=F,title=index festorum., options=vr_test_index,columns=2,columnseprule]
