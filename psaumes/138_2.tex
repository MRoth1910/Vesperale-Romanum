\item Intellexísti cogitatiónes meas de \textbf{lon}ge:~* sémitam meam et funículum meum inve\tinyhspace\textit{sti}\textbf{gá}sti.
\item Et omnes vias meas prævi\textbf{dí}sti:~* quia non est sermo in lin\textit{gua} \textbf{me}a.
\item Ecce Dómine tu cognovísti ómnia novíssima et an\textbf{tí}qua:~* tu formásti me, et posuísti super me ma\teenyhspace\textit{num} \textbf{tu}am.
\item Mirábilis facta est sciéntia tua \textbf{ex} me:~* confortáta est, et non pótero \textit{ad} \textbf{e}am.
\item Quo ibo a spíritu \textbf{tu}o?~* et quo a fácie tu\tinyhspace\textit{a} \textbf{fú}giam?
...
\item Quia tu possedísti renes \textbf{me}os:~* suscepísti me de útero ma\tinyhspace\textit{tris} \textbf{me}æ.
\item Confitébor tibi quia terribíliter magnificátus es:~† mirabília ópera \textbf{tu}a,~* et ánima mea cognó\tinyhspace\textit{scit} \textbf{ni}mis.
...
\item Si occíderis Deus pecca\textbf{tó}res:~* viri sánguinum, decliná\tinyhspace\textit{te} \textbf{a} me.
\item Quia dícitis in cogitati\textbf{ó}ne:~* Accípient in vanitáte civitá\tinyhspace\textit{tes} \textbf{tu}as.
...
\item Proba me Deus, et scito cor \textbf{me}um:~* intérroga me, et cognósce sémi\tinyhspace\textit{tas} \textbf{me}as.
