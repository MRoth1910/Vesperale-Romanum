\item Donec ponam inimícos \textbf{tu}os,~* scabéllum pe\hspace{0.03em}\textit{dum} \textit{tu}\textbf{ó}rum.
...
\item De torrénte in via \textbf{bi}bet:~* proptérea exal\hspace*{0.03em}\textit{tábit} \textbf{ca}put.
