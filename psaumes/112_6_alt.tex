\item Sit nomen Dómini be\teenyhspace\textit{ne}\textbf{dí}ctum,~* ex hoc nunc, et us\tinyhspace\textit{que} \textit{in} \textbf{sǽ}culum.
\item A solis ortu usque ad \textit{oc}\textbf{cá}sum,~* laudábile \textit{nomen} \textbf{Dó}mini.
\item Excélsus super omnes gen\teenyhspace\textit{tes} \textbf{Dó}minus,~* et super cælos gló\textit{ria} \textbf{e}jus.
