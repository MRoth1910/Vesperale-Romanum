\item Potens in terra erit \textbf{se}men \textbf{e}jus:~* generátio rectórum bene\hspace{0.03em}\textit{di}\textbf{cé}tur.
\item Glória et divítiæ in \textbf{do}mo \textbf{e}jus:~* et justítia ejus manet in sǽcu\hspace{0.03em}\textit{lum} \textbf{sǽ}culi.
...
\item Parátum cor ejus speráre in Dómino,~† confirmátum \textbf{est} cor \textbf{e}jus:~* non commovébitur donec despíciat inimí\hspace{0.03em}\textit{cos} \textbf{su}os.
