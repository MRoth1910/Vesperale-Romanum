...
\item Símiles illis fiant qui fá\textit{ciunt} \textbf{e}a:~* et o\-mnes qui con\textit{fídunt} \textit{in} \textbf{e}is.
...
\item Non mórtui laudá\textit{bunt} \textit{te,} \textbf{Dó}mine:~* neque o\-mnes, qui descén\textit{dunt} \textit{in} \textit{in}\textbf{fér}num.
