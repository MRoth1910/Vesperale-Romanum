\item Qui cogitavérunt iniquitátes in \textbf{cor}de:~* tota die constitu\hspace*{0.03em}\textit{ébant} \textbf{prǽ}lia.
\item Acuérunt linguas suas sicut ser\textbf{pén}tis:~* venénum áspidum sub lábi\hspace*{0.03em}\textit{is} \textit{e}\textbf{ó}rum.
\item Custódi me Dómine de manu pecca\textbf{tó}ris:~* et ab homínibus iníquis \textit{éri}\textbf{pe} me.
\item Qui cogitavérunt supplantáre gressus \textbf{me}os:~* abscondérunt supérbi lá\hspace*{0.03em}\textit{queum} \textbf{mi}hi:
\item Et funes extendérunt in \textbf{lá}queum:~* juxta iter scándalum posu\hspace*{0.03em}\textit{érunt} \textbf{mi}hi.
\item Dixi Dómino: Deus meus \textbf{es} tu:~* exáudi, Dómine, vocem deprecati\hspace*{0.03em}\textit{ónis} \textbf{me}æ.
...
\item Cognóvi quia fáciet Dóminus judícium \textbf{ín}opis:~* et vin\hspace*{0.03em}\textit{díctam} \textbf{páu}perum.
