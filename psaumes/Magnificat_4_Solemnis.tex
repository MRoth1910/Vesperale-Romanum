...
\item 9. Suscépit Israel \textit{púerum} \textbf{su}um,~* recordátus miseri\kern 0.01em\textit{córdiæ} \textbf{su}æ.
...
\item 12. Sicut erat in princípio, \textit{et} \textit{nunc,} \textit{et} \textbf{sem}per,~* et in sǽcula sæ\kern 0.01em\textit{culórum}. \textbf{A}men.