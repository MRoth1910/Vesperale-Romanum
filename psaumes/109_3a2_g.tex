\item Donec ponam ini\textbf{mí}cos \textbf{tu}os,~* scabéllum pe\tinyhspace\textit{dum} \textit{tu}\textbf{ó}rum.
...
\item Jurávit Dóminus, et non pæni\textbf{té}bit \textbf{e}um:~* Tu es sacérdos in ætérnum secúndum órdi\tinyhspace\textit{nem} \textit{Mel}\textbf{chí}sedech.
\item Dóminus a \textbf{dex}tris \textbf{tu}is,~* confrégit in die iræ \textit{suæ} \textbf{re}ges.
\item Judicábit in natiónibus, im\textbf{plé}bit ru\tinyhspace\textbf{í}nas:~* conquassábit cápita in ter\textit{ra} \textit{mul}\textbf{tó}rum.
\item De torrénte in \textbf{vi}a \textbf{bi}bet:~* proptérea exal\tinyhspace\textit{tábit} \textbf{ca}put.
