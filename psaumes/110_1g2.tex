\item 2. Magna \textbf{ó}pera \textbf{Dó}mini:~* exquisíta in omnes volun\hspace{0.03em}\textit{tátes} \textbf{e}jus.
...
%%LaTeX refuses to acknowledge the line break with hspace inserted so a manual, hard hyphen was inserted in v 10

%if using default nonfrenchspacing \@ needed particulaarly in v 4 and v 6