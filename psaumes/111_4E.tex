...
\item Dispérsit, dedit paupéribus:~† justítia ejus manet in sǽ\hspace*{0.03em}\textit{culum} \textbf{sǽ}culi,~* cornu ejus exaltá\hspace*{0.03em}\textit{bitur} \textit{in} \textbf{glóri}a.
