...
\item 8. Glória Pa\textit{tri,} \textit{et} \textbf{Fí}lio,~* et Spi\hspace{0.03em\textit{rítui} \textbf{San}cto.
\item 9. Sicut erat in princípio, et \textit{nunc,} \textit{et} \textbf{sem}per,~* et in sǽcula sæ\hspace{0.03em}\textit{culórum.} \textbf{A}men.
