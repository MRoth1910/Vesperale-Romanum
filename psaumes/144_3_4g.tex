...
\item Oculi ómnium in te \textit{sperant} \textbf{Dó}mine:~* et tu das escam illórum in témpore oppor\textbf{tú}no.
\item Aperis tu \textit{manum} \textbf{tu}am:~* et imples omne ánimal benedicti\textbf{ó}ne.
\item Justus Dóminus in ómnibus \textit{viis} \textbf{su}is:~* et sanctus in ómnibus opéribus \textbf{su}is.
...
\item Laudatiónem Dómini loqué\hspace{0.03em}\textit{tur} \textit{os} \textbf{me}um:~* et benedícat omnis caro nómini sancto ejus in sǽculum et in sǽculum \textbf{sǽ}culi.
