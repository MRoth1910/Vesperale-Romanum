...
\item Quid retrí\textit{buam} \textbf{Dó}mino,~* pro ómnibus quæ re\hspace*{0.03em}\textit{tríbuit} \textbf{mi}hi?
\item Cálicem salutá\textit{ris} \textit{ac}\textbf{cí}piam:~* et nomen Dómi\hspace*{0.03em}\textit{ni} \textit{invo}\textbf{cá}bo.
...
\item Dirupísti víncula mea:~† tibi sacrificábo hó\textit{stiam} \textbf{lau}dis,~* et nomen Dómi\hspace*{0.03em}\textit{ni} \textit{invo}\textbf{cá}bo.
