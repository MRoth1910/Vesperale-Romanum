...
%\chapter[Toni Communes.]{TONI COMMUNES.}\header{toni communes.} %% Need to redefine chapter to allow for optional argument to be used in TOC

\thispagestyle{empty}

\section[In Principio Vesperarum.]{IN PRINCIPIO VESPERARUM.}\header{in principio vesperarum.}
...
\section[Toni Psalmorum.]{TONI PSALMORUM.}\header{toni psalmorum.}
...
\section[Toni Versiculorum.]{TONI VERSICULORUM.}\header{toni versiculorum.}
...
\section[Tonus Capituli.]{TONUS CAPITULI.}\header{tonus capituli.}
...
\section[Toni Orationum.]{TONI ORATIONUM.}\header{toni orationum.}
...
\section[In fine Horarum.]{IN FINE HORARUM.}\header{in fine horarum.}
...
\section[Toni ℣. Benedicamus Domino.]{TONI ℣. BENEDICAMUS DOMINO.}\header{toni ℣. benedicamus domino.}
...
\section[De Cantu Hymnorum.]{DE CANTU HYMNORUM.}\header{de cantu hymnorum.}
...
\section[Toni « Allelúia ».]{TONI ALLELUIA.}\header{toni « alleluia ».}
